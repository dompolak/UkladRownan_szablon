...
uklad_szablon: obj/main.o obj/Wektor.o obj/Zespolona.o obj/Wektor_def.o
...
obj/Wektor_def.o: src/Wektor_def.cpp 
	g++ ${CPPFLAGS} -o obj/Wektor_def.o src/Wektor_def.cpp
